    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="bg-amber-50 border-b border-amber-200 px-4 py-2 flex items-center justify-center gap-2">
        ...
        <p className="text-xs text-amber-800">
          <span className="font-semibold">Disclaimer:</span> This chatbot is hosted outside of the official OCBC domain and is for internal demo purposes only. Please do not enter any sensitive personal or financial information (NRIC, account numbers, passwords, etc.).
        </p>
      </div>
